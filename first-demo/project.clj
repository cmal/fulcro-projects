(defproject first-demo "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds [{:id           "production"
                        ...
                        :compiler     {:asset-path    "js/prod"
                                       :main          first-demo.client-main
                                       :optimizations :advanced
                                       :source-map    "resources/public/js/first_demo.js.map"
                                       :output-dir    "resources/public/js/prod"
                                       :output-to     "resources/public/js/first_demo.js"}}]}

  :profiles {:uberjar    {:main           first-demo.server-main
                          :aot            :all
                          ...
                          :cljsbuild    {:builds
                                         [{:id           "dev"
                                          ...
                                          {:id           "test"
                                           ...
                                           :figwheel     {:on-jsload "first-demo.client-test-main/client-tests"}
                                           :compiler     {:asset-path    "js/test"
                                                          :main          first-demo.client-test-main
                                                          :optimizations :none
